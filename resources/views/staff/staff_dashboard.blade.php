    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('aid_res.storee') }}">
                    @csrf

                    <div class="form-group">
                        <label for="ComID">Nama Ketua Kumpulan:</label>
                        <input type="hidden" name="ComID" value="{{ auth()->user()->userID}}">
                        <input class="form-control" readonly value="{{ auth()->user()->name }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="aid_resQuantity" class="form-control" required>
