            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('profile.JKKUpdate') }}" class="mt-6 space-y-6">
                            @csrf
                            @method('patch')

                            <!-- Form Row-->
                            <div class="mb-3">
                                <label class="form-label" for="address">Nama Kampung</label>
                                <input class="form-control" id="VillageName" name="VillageName" type="text" value="{{ $JKK->VillageName }}" 
                                oninput="this.value = this.value.toUpperCase()">
                            </div>
                            <!-- Form Row-->
                            <div class="mb-3">

                                <label class="form-label" for="phoneNum">Nombor Telefon</label>
                                <input class="form-control" id="SPhoneNum" name="JKKPhoneNum" type="text" value="{{ $JKK->JKKPhoneNum }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="JKKEmail" name="JKKEmail" type="email"
