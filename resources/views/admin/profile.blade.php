            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('profile.AdminUpdate') }}" class="mt-6 space-y-6">
                            @csrf
                            @method('patch')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="SPhoneNum" name="SPhoneNum" type="text" value="{{ $staff->SPhoneNum }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" required id="SEmail" name="SEmail" type="email"
